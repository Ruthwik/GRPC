...
public final class CalculatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.PrimeNumberDecompositionRequest,
      com.example.grpc.PrimeNumberDecompositionResponse> getPrimeNumberDecompositionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PrimeNumberDecomposition",
      requestType = com.example.grpc.PrimeNumberDecompositionRequest.class,
      responseType = com.example.grpc.PrimeNumberDecompositionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.grpc.PrimeNumberDecompositionRequest,
      com.example.grpc.PrimeNumberDecompositionResponse> getPrimeNumberDecompositionMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.PrimeNumberDecompositionRequest, com.example.grpc.PrimeNumberDecompositionResponse> getPrimeNumberDecompositionMethod;
      ...
      synchronized (CalculatorServiceGrpc.class) {
        if ((getPrimeNumberDecompositionMethod = CalculatorServiceGrpc.getPrimeNumberDecompositionMethod) == null) {
          CalculatorServiceGrpc.getPrimeNumberDecompositionMethod = getPrimeNumberDecompositionMethod = 
              io.grpc.MethodDescriptor.<com.example.grpc.PrimeNumberDecompositionRequest, com.example.grpc.PrimeNumberDecompositionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "CalculatorService", "PrimeNumberDecomposition"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.PrimeNumberDecompositionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.PrimeNumberDecompositionResponse.getDefaultInstance()))
  ...
  public static abstract class CalculatorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void primeNumberDecomposition(com.example.grpc.PrimeNumberDecompositionRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.PrimeNumberDecompositionResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                com.example.grpc.PrimeNumberDecompositionRequest,
                com.example.grpc.PrimeNumberDecompositionResponse>(
  ...
  public static final class CalculatorServiceBlockingStub extends io.grpc.stub.AbstractStub<CalculatorServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<com.example.grpc.PrimeNumberDecompositionResponse> primeNumberDecomposition(
        com.example.grpc.PrimeNumberDecompositionRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PRIME_NUMBER_DECOMPOSITION:
          serviceImpl.primeNumberDecomposition((com.example.grpc.PrimeNumberDecompositionRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.PrimeNumberDecompositionResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CalculatorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.Serverstream.getDescriptor();
    }
